...
const constants = require('../generator-constants'),
    ...
    CLIENT_DIR = constants.CLIENT_DIR,
...
module.exports = EntityGenerator.extend({
    constructor: function () {
        ...
        // This adds support for a `--client-suffix` flag
        this.option('client-suffix', {
            desc: 'Use a suffix to generate client routes and files, to avoid name clashes',
            type: String,
            defaults: ''
        });
        ...
        this.entityClientSuffix = this.options['client-suffix'];
        this.skipServer = this.config.get('skipServer') || this.options['skip-server'];
        if (this.entityClientSuffix && !this.entityClientSuffix.startsWith('-')){
            this.entityClientSuffix = '-' + this.entityClientSuffix;
        }
    ...
    initializing: {
        getConfig: function (args) {
            ...
            this.clientAppName = this.getAppName();
    ...
    _loadJson: function () {
        ...
        if (this.fileData.aureliaSuffix !== undefined){
            this.entityClientSuffix = this.fileData.aureliaSuffix;
        }
    ...
    configuring : {
        ...
        writeEntityJson: function () {
            ...
            if (this.entityClientSuffix) {
                this.data.aureliaSuffix = this.entityClientSuffix;
            }
        ...
        loadInMemoryData: function () {
            ...
            this.entityFileName = entityNameSpinalCased + this.entityClientSuffix;
            this.entityPluralFileName = entityNamePluralizedAndSpinalCased + this.entityClientSuffix;
            this.entityServiceFileName = entityNameSpinalCased;
            this.entityClientName = this.entityClass + _.upperFirst(_.camelCase(this.entityClientSuffix));
            this.entityStateName = entityNameSpinalCased + this.entityClientSuffix;
            this.entityUrl = entityNameSpinalCased + this.entityClientSuffix;
            ...
            this.relationships && this.relationships.forEach( function (relationship) {
                ...
                if (_.isUndefined(relationship.otherEntityStateName)) {
                    relationship.otherEntityStateName = _.trim(_.kebabCase(relationship.otherEntityName), '-') + this.entityClientSuffix;
                }
    ...
    writing : {
        ...
        writeEnumFiles: function() {
            ...
            for (var idx in this.fields) {
                ...
                if (field.fieldIsEnum === true) {
                    ...
                    enumInfo.clientAppName = this.clientAppName;
        ...
        writeClientFiles: function () {
            ...
            this.copyHtml(CLIENT_DIR + 'entities/_entity-management.html', CLIENT_DIR + 'entities/' + this.entityFolderName + '/' + this.entityPluralFileName + '.html', this, {}, true);
            this.copyHtml(CLIENT_DIR + 'entities/_entity-management-detail.html', CLIENT_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-detail.html', this, {}, true);
            this.copyHtml(CLIENT_DIR + 'entities/_entity-management-dialog.html', CLIENT_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-dialog.html', this, {}, true);
            this.copyHtml(CLIENT_DIR + 'entities/_entity-management-delete-dialog.html', CLIENT_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-delete-dialog.html', this, {}, true);

            this.addEntityToMenu(this.entityStateName, this.enableTranslation);

            this.template(CLIENT_DIR + 'entities/_entity-management.state.js', CLIENT_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '.state.js', this, {});
            this.template(CLIENT_DIR + 'entities/_entity-management.controller.js', CLIENT_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '.controller' + '.js', this, {});
            this.template(CLIENT_DIR + 'entities/_entity-management-dialog.controller.js', CLIENT_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-dialog.controller' + '.js', this, {});
            this.template(CLIENT_DIR + 'entities/_entity-management-delete-dialog.controller.js', CLIENT_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-delete-dialog.controller' + '.js', this, {});
            this.template(CLIENT_DIR + 'entities/_entity-management-detail.controller.js', CLIENT_DIR + 'entities/' + this.entityFolderName + '/' + this.entityFileName + '-detail.controller' + '.js', this, {});
            this.template(CLIENT_DIR + 'services/_entity.service.js', CLIENT_DIR + 'entities/' + this.entityFolderName + '/' + this.entityServiceFileName + '.service' + '.js', this, {});
            if (this.searchEngine === 'elasticsearch') {
                this.template(CLIENT_DIR + 'services/_entity-search.service.js', CLIENT_DIR + 'entities/' + this.entityFolderName + '/' + this.entityServiceFileName + '.search.service' + '.js', this, {});
            }
